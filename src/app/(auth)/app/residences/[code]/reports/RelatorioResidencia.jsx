...
export default function RelatorioResidencia({
    ...
    const trocarAba = (novaAba) => irPara(novaAba, competencia.month, competencia.year);
    const trocarCompetencia = (mes, ano) => irPara(abaAtiva, mes, ano);
                                    ...
                                    <div className={styles.categoriaRodape}>
                                        ...
                                        {categoria.desvio !== null && (
                                            <span className={categoria.acimaDaMedia ? styles.desvioAlto : styles.desvioBaixo}>
                                                {categoria.acimaDaMedia ? '▲' : '▼'} {Math.abs(categoria.desvio * 100).toFixed(0)}% vs. média de {formatarValor(categoria.mediaInCents)}
                                            </span>
                                        )}
                                    </div>
                                </li>
