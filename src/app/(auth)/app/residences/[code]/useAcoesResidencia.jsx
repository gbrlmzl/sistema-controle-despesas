...
export default function useAcoesResidencia(residencia, abrirConviteInicial = false) {
    ...
    const executarAcao = async (acao, { redirecionarPara } = {}) => {
        setProcessando(true);
    ...
    const confirmarRemocao = (membro) => setConfirmacao({
