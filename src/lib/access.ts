...
export function calcularExpiracaoConvite(): Date {
...
export async function expirarConvitesVencidos(): Promise<void> {
...
export async function listarConvitesRecebidos(userId: number) {
...
export async function listarConvitesEnviados(residenceId: number) {
    await expirarConvitesVencidos();
...
export async function listarSolicitacoesPendentes(residenceId: number) {
...
export async function listarSolicitacoesEnviadas(userId: number) {
    const solicitacoes = await db.joinRequest.findMany({
...
export async function bloqueioPorRecusaRecente(residenceId: number, userId: number): Promise<Date | null> {
    ...
    if (!recusaRecente || !recusaRecente.respondedAt) {
        return null;
    }
