...
export async function criarNotificacao({ userId, type, title, message, linkTo }: NovaNotificacao) {
...
export async function criarNotificacoes(notificacoes: NovaNotificacao[]) {
...
export async function listarNotificacoes(userId: number, { limite, pagina }: OpcoesListagem = {}) {
...
export async function marcarComoLidas(userId: number, ids: number[]) {
