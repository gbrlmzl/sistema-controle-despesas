...
export function normalizeResidenceCode(code) {
...
export async function gerarCodigoDisponivel() {
...
export async function listarResidenciasDoUsuario(userId) {
...
export async function buscarResidenciaDoMembro(code, userId) {
...
export async function carregarVinculoDoUsuario(code, email) {
    const codigoNormalizado = normalizeResidenceCode(code);
