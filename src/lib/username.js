...
export async function usernameEmUso(username) {
...
export async function gerarUsernameDisponivel(textoBase) {
    const raiz = normalizeUsername(textoBase).replace(/[^a-z0-9_]/g, "").slice(0, 15);
