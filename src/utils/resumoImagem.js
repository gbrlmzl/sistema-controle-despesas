...
async function carregarFonteEmBase64() {
    try {
...
function montarSvg({ residencia, competencia, totalInCents, participantes, fonteBase64 }) {
...
async function svgParaPng(svg, largura, altura) {
...
export async function compartilharResumoDaResidencia({ residencia, competencia, totalInCents, participantes }) {
